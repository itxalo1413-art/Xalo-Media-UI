    ...
    return (
        <div className="space-y-8 max-w-5xl mx-auto">
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h2 className="text-3xl font-black text-gray-900 tracking-tight">Cập nhật tin tuyển dụng</h2>
                    <p className="text-gray-500 mt-1 font-bold">Chỉnh sửa thông tin: <span className="text-digital-blue">{formData.title}</span></p>
                </div>
            </div>
                     ...
                     <div className="bg-white p-8 rounded-[24px] border border-gray-100 shadow-sm space-y-6 sticky top-8">
                        ...
                        >
                         ...
                         <button
                            ...
                            disabled={loading}
                            className="w-full py-4 bg-red-50 text-red-500 rounded-2xl font-black hover:bg-red-100 transition-all flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
