...
export default function NewKolPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (data.success) {
                toast.success('Tạo KOL thành công');
    ...
    return (
        <div className="space-y-8 max-w-5xl mx-auto">
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h2 className="text-3xl font-black text-gray-900 tracking-tight">Thêm KOL mới</h2>
                    <p className="text-gray-500 mt-1 font-bold">Thêm thông tin KOL vào hệ thống.</p>
                </div>
            </div>
