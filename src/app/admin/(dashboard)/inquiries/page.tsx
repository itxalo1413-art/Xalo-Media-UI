    ...
    <div className='space-y-8'>
      ...
      <div>
        ...
        <p className='text-gray-500 mt-1 font-bold'>
          Quản lý và phản hồi các yêu cầu từ khách hàng tiềm năng.
        </p>
      </div>

      {/* Filters and Stats */}
      <div className='grid grid-cols-1 md:grid-cols-4 gap-4'>
        <div className='md:col-span-1 bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-center'>
          <p className='text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1'>
            Tổng yêu cầu bài này
          </p>
                  ...
                  <td className='px-8 py-6'>
                    <div className='flex flex-wrap gap-1 max-w-50'>
                      {item.interestedServices.map((service, idx) => (
                        <span
                          key={idx}
                          className='px-2 py-0.5 bg-blue-50 text-digital-blue text-[10px] font-black rounded-md'
                        >
                          {service}
                        </span>
                      ))}
