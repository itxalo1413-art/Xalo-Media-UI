...
import { toast } from 'sonner'; // Import toast để thông báo (nếu bạn dùng thư viện này)
...
const navigation = [
  ...
  { name: 'KOLs', href: '/admin/kol', icon: Users },
  { name: 'Tuyển dụng', href: '/admin/recruitment', icon: Briefcase },
];
        ...
        {navigation.map((item) => {
          ...
          return (
            ...
            >
              ...
              {isActive && (
                <div className='w-1.5 h-1.5 rounded-full bg-digital-blue shadow-sm' />
              )}
              {!isActive && (
